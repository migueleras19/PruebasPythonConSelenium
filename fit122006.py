...
class Ingreso122006(unittest. TestCase):
    ...
    def testtemplates(self):
        ...
        time.sleep(1.5)
        subsistema = driver.find_element_by_id("c_C1Csubsistema_0")
        subsistema.send_keys("03")
        trans = driver.find_element_by_id("c_C5Ctransaccion_0")
        trans.send_keys("6300")
        trans.send_keys("webdrive" + Keys.ENTER)
        time.sleep(2)
        template = driver.find_element_by_name("plantilla_0").send_keys("/home/qacore/Escritorio/SectorPublico/templates/036300-RECAUDACION_CORRESPONSALIAS.xls")
        time.sleep(4)
