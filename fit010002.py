...
class Ingreso01002(unittest. TestCase):
    ...
    def testSubirformularios(self):
         ...
         time.sleep(2)
         form = driver.find_element_by_name("archivo_0").send_keys("/home/qacore/Escritorio/SectorPublico/forms/FORMS.zip")
         time.sleep(2)
    ...
    def testSubirreportes(self):
        ...
        trans.send_keys("webdrive" + Keys.ENTER)
        time.sleep(3)
        reports = driver.find_element_by_name("archivo_0").send_keys("/home/qacore/Escritorio/SectorPublico/reports/REPORTS.zip")
        time.sleep(2)
